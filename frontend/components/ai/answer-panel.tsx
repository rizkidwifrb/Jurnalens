  ...
  return (
    <Card className="space-y-5 overflow-hidden">
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-2 text-sm font-semibold"><BrainCircuit className="h-4 w-4 text-accent" /> Sintesis Jurnalens</div>
      ...
      <p className="whitespace-pre-wrap text-sm leading-7 text-[#c7d2df]">{answer || "Jalankan pencarian untuk membuat jawaban berbasis sumber dari index dan sumber akademik live."}</p>
