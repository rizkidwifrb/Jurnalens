...
export function UploadPanel() {
  return (
    <Card className="flex min-h-56 flex-col items-center justify-center gap-4 border-dashed text-center">
      ...
      <div>
        <h2 className="text-lg font-semibold">Unggah PDF paper</h2>
        <p className="mt-2 max-w-xl text-sm leading-6 text-muted">Ekstrak teks, chunk halaman, buat embedding, lalu chat dengan dokumen.</p>
      </div>
